...
**Other files:**
- [f14b7ce3.md](https://github.com/igorratn/coyote-math/blob/main/f14b7ce3.md): Hyperbolic distance computation. **Answer: 1.82**
...
Additional standalone TeX: `poincare_AB_asymmetric-i.tex`
...
| f14b7ce3 | 1. Hyperbolic | Hyperbolic distance | No | 1.82 |
