...
Let $L_n^{(alpha)}(t)$ be the Laguerre polynomials. For $mathrm{Re}(alpha) > -1$ and $z in mathbb{C} setminus [0, infty)$, define the Laguerre function of the second kind: $$Q_n^{(alpha)}(z) = ... [[9c127187.md]](https://github.com/igorratn/coyote-math/blob/main/9c127187.md)
