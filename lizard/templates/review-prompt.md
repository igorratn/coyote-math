...
- Type 3: Fine-grained precision beyond what image supports
...
- Logical Reasoning: simple counting rules (singular vs plural, case-sensitive vs not) are Enumeration, not Logical Reasoning.
