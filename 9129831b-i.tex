...
% Orientation arrow along the u-curve, placed away from P (on the upper arc)
\draw[blue,->,line width=1] ({2.3*cos(110)},{2.3*sin(110)}) 
    arc[start angle=110,end angle=70,radius=2.3];
\node[blue] at ({2.6*cos(90)},{2.6*sin(90)}) {$v\downarrow$};
