...
img_path = Path('/Users/iratnere/dev/coyote-math/peacock/screenshots/figure_4_1_fea_labeled.png')
out_path = Path('/Users/iratnere/dev/coyote-math/peacock/screenshots/figure_4_1_fea_labeled_points_sigma.png')
...
# Prompt-style points, evaluated on the layered tire FEA plot
points = {
    'P1': (0.00, 0.50, +0.3023),
    'P2': (0.875, 0.35, -0.0190),
    'P3': (0.00, 1.50, +0.2002),
    'P4': (1.50, 0.50, -0.0231),
}
offsets = {
...
for name, (x, z, s) in points.items():
    ...
    dx, dy = offsets[name]
    tx, ty = px + dx, py + dy
    lines = [name, f'σzo/p0 = {s:+.4f}', f'({x:.3f}a, {z:.2f}a)']
    widths = []; heights = []
