...
points = {
    ...
    'P2': (0.775, 0.375, value_at(0.775, 0.375)),
    'P3': (0.000, 1.500, value_at(0.000, 1.500)),
    'P4': (1.500, 0.500, value_at(1.500, 0.500)),
}
...
out=Path('/Users/iratnere/dev/coyote-math/peacock/screenshots/layered_e10_trap_points_sigma.png')
