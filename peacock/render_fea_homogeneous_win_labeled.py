...
for n1,n2,n3 in elements:
    Ke,B = element_K_B(nodes[[n1,n2,n3]])
    Bs.append((B,n1,n2,n3))
...
for lev, polys in contours.items():
    ...
    for poly in polys:
        ...
        placed += 1
        if placed >= 2: break
out=Path('/Users/iratnere/dev/coyote-math/peacock/screenshots/homogeneous_33L32FI34_fea_labeled.png')
